...
| [Daily AI Intel Digest](./workflows/daily-ai-intel-digest/) | Pulls from 10 RSS sources every 3 hours, filters by tier, generates a dark-themed HTML digest via GPT-4.1-mini, and delivers it via Gmail. |
